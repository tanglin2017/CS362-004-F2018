...
int main() {
 ...
 /*   int returnCode=cardEffect(remodel, choice1, choice2, choice3, &G, handpos, &bonus);// calista called remodel function inside cardEffect, there was no way to get return code for remodel function
